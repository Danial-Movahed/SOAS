...
"padding: 0px 5px;")
        ...
        self.EditSentRequestBtn = QtWidgets.QPushButton(self.SentTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.EditSentRequestBtn.sizePolicy().hasHeightForWidth())
        self.EditSentRequestBtn.setSizePolicy(sizePolicy)
        self.EditSentRequestBtn.setMaximumSize(QtCore.QSize(16777215, 100))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.EditSentRequestBtn.setFont(font)
        self.EditSentRequestBtn.setStyleSheet("background-color: rgb(5, 163, 55);\n"
"border-radius: 10px;\n"
"padding: 0px 5px;")
        self.EditSentRequestBtn.setObjectName("EditSentRequestBtn")
        self.horizontalLayout_2.addWidget(self.EditSentRequestBtn)
...
"padding: 0px 5px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.EditSentRequestBtn.setText(_translate("MainWindow", "Edit Request"))
